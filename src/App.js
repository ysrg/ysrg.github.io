          ...
          >
            <div className="content">
              <div className="about">
                ...
                such as the approaching technological singularity or the
                probability that time is just an illusion we use to measure the
                entropy of our universe. My biggest strength is the ability to
                focus. I am the antithesis of multitasking. If you would like to
                hire me or just say hi, feel free to get in touch with me 👋.
              </div>
              <div className="stack">
